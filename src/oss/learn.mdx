...
<Card title="Customer Support State Machine" icon="people-arrows" href="/oss/langchain/customer-support-state-machine" horizontal>
  Build a customer support workflow where a single agent transitions between different states.
</Card>

<Card title="On-demand Skill Loading" icon="wand-magic-sparkles" href="/oss/langchain/progressive-disclosure-skills" horizontal>
...
<Card title="Custom RAG Agent" icon="user-magnifying-glass" href="/oss/langgraph/agentic-rag" horizontal>
...
<Card title="Case Studies" icon="screen-users" href="/oss/langgraph/case-studies" horizontal>
