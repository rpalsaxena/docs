...
<ParamField body="trigger" type="ContextSize | list[ContextSize] | None">
    ...
    - A single @[`ContextSize`] dict (all properties must be met - AND logic)
    - A list of @[`ContextSize`] dicts (any condition must be met - OR logic)
...
<Columns cols={2}>
    <Card title="Anthropic" href="/oss/integrations/providers/anthropic#middleware" icon="anthropic" arrow>
        Prompt caching, bash tool, text editor, memory, and file search middleware for Claude models.
    </Card>
    <Card title="OpenAI" href="/oss/integrations/providers/openai#middleware" icon="openai" arrow>
