...
<Update label="Dec 15, 2025" tags={["langchain", "integrations"]}>
    ...
    * Simplified support for provider-specific tool parameters and definitions in [`create_agent`](/oss/langchain/agents) via the [`extras`](https://reference.langchain.com/python/langchain/tools/#langchain.tools.BaseTool.extras) attribute on [tools](/oss/langchain/tools). Examples:
    ...
    * Support for [strict](/oss/langchain/structured-output#provider-strategy) schema-adherence in agent `response_format`.
</Update>
