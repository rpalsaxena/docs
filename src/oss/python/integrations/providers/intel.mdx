...
See a [usage example](/oss/integrations/text_embedding/optimum_intel).
...
See a [usage example](/oss/integrations/text_embedding/itrex).
...
See a [usage example](/oss/integrations/llms/weight_only_quantization).
