...
<Info>
We now support Redis Cluster for LangSmith as of helm version **0.12.25**. You can find the helm values to configure under [redis.external.cluster](https://github.com/langchain-ai/helm/blob/main/charts/langsmith/values.yaml), and an example configuration [here](https://github.com/langchain-ai/helm/blob/main/charts/langsmith/examples/redis_cluster.yaml)
</Info>
