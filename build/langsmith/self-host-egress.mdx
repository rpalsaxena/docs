...
You can disable all telemetry by setting the following values in your `langsmith_config.yaml` file (you may also disable individual telemetry types as you see fit):
