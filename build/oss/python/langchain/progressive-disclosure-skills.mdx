---
title: Build an agent with on-demand skill loading
sidebarTitle: On-demand skill loading
---
...
- Explore the [handoffs pattern](/oss/python/langchain/customer-support-handoffs) for sequential workflows
- Read the [supervisor pattern](/oss/python/langchain/supervisor) for parallel task routing
