...
This tutorial demonstrates how to interact with LangChain [agents](/oss/python/langchain/agents) through voice channels. It follows the reference architecture implemented in the [LangChain repo](https://github.com/langchain-ai/voice-sandwich-demo).
