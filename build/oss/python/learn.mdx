...
<Card title="Customer Support Handoffs" icon="people-arrows" href="/oss/python/langchain/customer-support-handoffs" horizontal>
  Build a customer support workflow where a single agent transitions between different states.
</Card>

<Card title="On-demand Skill Loading" icon="wand-magic-sparkles" href="/oss/python/langchain/progressive-disclosure-skills" horizontal>
