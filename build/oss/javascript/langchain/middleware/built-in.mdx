...
<Columns cols={2}>
    <Card title="Anthropic" href="/oss/javascript/integrations/providers/anthropic#middleware" icon="anthropic" arrow>
        Prompt caching, bash tool, text editor, memory, and file search middleware for Claude models.
    </Card>
    <Card title="OpenAI" href="/oss/javascript/integrations/providers/openai#middleware" icon="openai" arrow>
