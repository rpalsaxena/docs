...
```typescript
import { ChatAnthropic, tools, type Bash20250124Command } from "@langchain/anthropic";
...
<Callout icon="pen-to-square" iconType="regular">
    [Edit the source of this page on GitHub.](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/tools/anthropic.mdx)
</Callout>
